// pattern_slot_marker.js — Marque le User Pattern courant s'il est occupe.
// Inlet 0 : liste des slots utilises (21..40), bang = liste vide.
// Inlet 1 : slot Pattern actuellement affiche.
...
// Un rechargement/autowatch du JSUI efface sa liste locale. Redemander l'etat
// des deux moteurs garantit que chaque instance recoit sa liste via son propre
// Pattern Editor sans attendre une nouvelle sauvegarde.
...
function clampSlot(v) {
    return Math.max(1, Math.min(40, Math.round(Number(v) || 1)));
}
